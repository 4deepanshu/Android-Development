...
public class LockScreenView extends Service implements OnClickListener {
    static View mView;
    ...
    public static void stopService() {
        try {
            service.stopSelf();
            DetectLockService.isLockViewVisible = false;
        ...
        edittextPassword.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.toString().equalsIgnoreCase(SharedPref.getString(MyApplication.STUDENT_PASSWORD))) {
                    ...
                    dataBaseHandler.truncateTableAppLockLock();
