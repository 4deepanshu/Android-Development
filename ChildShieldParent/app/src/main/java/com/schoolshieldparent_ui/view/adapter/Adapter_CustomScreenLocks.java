...
public class Adapter_CustomScreenLocks extends BaseAdapter {
    ...
    public Adapter_CustomScreenLocks(Activity activity, List<CusLock> customLocks) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.imageButton_delete.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                WebServiceResult.deleteScreenlock( customLocks.get( position ).getLockId(), SharedPref.getString( MyApplication.PARENT_ID ), "parent", Activity_CustomScreenLock.getInstance().studentid, "0" );
